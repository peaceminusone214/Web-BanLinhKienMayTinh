...
const SearchResultsPage = () => {
  ...
  return (
    <div className="search-results-page container" style={{ maxWidth: "1220px", margin: "0 auto", padding: "20px 15px" }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        {results.length > 0 && (
          <span className="text-muted">
            Tìm thấy <strong>{results.length}</strong> sản phẩm cho từ khóa: <strong className="text-primary">"{keyword}"</strong>
          </span>
        )}
      </div>
