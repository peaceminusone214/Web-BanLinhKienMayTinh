        ...
        <div className="homepage-collection-swiper mx-auto" style={{ width: "1220px" }}>
            ...
            <div className="table-responsive">
                <table className="table table-bordered text-center align-middle">
                    ...
                    <tbody>
                        {renderRow("Ảnh", p => <img src={p.image_url} alt={p.product_name} style={{ height: "80px" }} />)}
                        {renderRow("Giá bán", (p) => (
                            <div>
                                <p
                                    style={{
                                ...
                                <button
                                    ...
                                    onMouseOver={(e) => (e.currentTarget.style.backgroundColor = "#d91605")}
                        ...
                        {renderRow("Tình trạng sử dụng", p => p.condition === "New" ? "Mới" : "Đã sử dụng")}
                        ...
                        {renderRow("Đánh giá", (p) => {
                            ...
                            return (
                                <div>
                                    <div style={{ fontSize: "20px", color: "#ffc107" }}>{stars}</div>
