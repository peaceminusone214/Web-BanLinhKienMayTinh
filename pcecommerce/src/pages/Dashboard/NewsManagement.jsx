  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingNews) {
        ...
        setNewsList(
          newsList.map((item) =>
            item._id === editingNews._id ? res.data : item
          )
        );
        setEditingNews(null);
      } else {
                ...
                <div className="sherah-dsinner">
                  ...
                  <div className="row mg-top-30">
                    <div className="col-12 sherah-flex-between">
                      ...
                      <a href="#newsForm" className="sherah-btn sherah-gbcolor">
                        Thêm Tin Tức
                      </a>
                    </div>
                  </div>
                    ...
                    >
                      <thead className="sherah-table__head">
                        <tr>
                          ...
                          <th className="sherah-table__column-3">Danh mục</th>
                          <th className="sherah-table__column-4">Tác giả</th>
                          <th className="sherah-table__column-5">Ngày tạo</th>
                      ...
                      <tbody className="sherah-table__body">
                        {loading ? (
                          <tr>
                            <td colSpan="6">Đang tải tin tức...</td>
                          </tr>
                        ) : error ? (
                          <tr>
                  ...
                  <div id="newsForm" className="mg-top-30">
                    <form onSubmit={handleSubmit} className="news-form">
                      ...
                      <input
                        ...
                        value={formData.category}
                        onChange={handleChange}
                        placeholder="Danh mục (ví dụ: tech, game, news, product)"
                        required
                      />
                      <input
                        type="text"
