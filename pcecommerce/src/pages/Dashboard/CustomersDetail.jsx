        ...
        <div className="col-lg-4">
          <div className="card shadow-sm text-center">
            <div className="card-body">
              <img
                src={user.image_url || "/assets/interface-dashboard/img/customer-profile.png"}
                alt="Avatar"
                className="rounded-circle mb-3"
                style={{ width: 120, height: 120, objectFit: "cover" }}
              />
              <h4 className="fw-bold">{user.name || "Chưa có tên"}</h4>
              <p className="mb-1 text-muted">{user.phoneNumber || "Chưa có số điện thoại"}</p>
              <p>
              ...
              <div className="bg-light p-2 rounded mt-3">
                <strong>Số dư tài khoản:</strong> <span className="text-success">$1200</span>
              </div>
              <ul className="list-unstyled mt-3 text-start">
                <li><strong>Ngày tạo:</strong> {new Date(user.created_at).toLocaleDateString()}</li>
                <li>
                  <strong>Trạng thái:</strong>{" "}
                  <span className={`badge ${user.deleted ? "bg-danger" : "bg-success"}`}>
          ...
          <div className="row g-4">
              ...
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  <ul className="list-unstyled">
                    ...
                    <li><strong>Ngày sinh:</strong> {user.dateOfBirth ? new Date(user.dateOfBirth).toLocaleDateString() : "Chưa cập nhật"}</li>
                    <li><strong>SĐT:</strong> {user.phoneNumber || "Chưa cập nhật"}</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  <ul className="list-unstyled">
                    <li><strong>Giới thiệu:</strong> {user.about || "Chưa cập nhật"}</li>
                    <li><strong>Ảnh đại diện:</strong> {user.image_url ? "Đã cập nhật" : "Chưa có"}</li>
                    <li>
