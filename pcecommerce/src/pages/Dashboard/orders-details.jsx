...
function Ordersdetails() {
  ...
  const [id, setId] = useState("67bbe49c637856c3b10608bb");
                      ...
                      <div className="sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                        ...
                        <div className="row">
                          <div className="col-lg-6 col-md-6 col-12 mg-top-30">
                            ...
                            <table id="sherah-table__orderv1" className="sherah-table__main sherah-table__main--orderv1">
      <thead className="sherah-table__head">
        <tr>
          <th className="sherah-table__column-1 sherah-table__h1">Hình ảnh</th>
          <th className="sherah-table__column-2 sherah-table__h2">Tên sản phẩm</th>
          <th className="sherah-table__column-3 sherah-table__h3">Đơn giá</th>
          <th className="sherah-table__column-4 sherah-table__h4">Tổng cộng</th>
        </tr>
      </thead>
          ...
          <tr key={product._id}>
            ...
            <td className="sherah-table__column-2 sherah-table__data-2">
              <div className="sherah-table__product-name">
                <h4 className="sherah-table__product-name--title">{product.product_name}</h4>
              </div>
            </td>
            <td className="sherah-table__column-3 sherah-table__data-3">
              <div className="sherah-table__product-content">
                <p className="sherah-table__product-desc">
                  {formatCurrency(product.price_per_unit)} x {product.quantity}
                </p>
              </div>
            </td>
            <td className="sherah-table__column-4 sherah-table__data-4">
              <div className="sherah-table__product-content">
                <p className="sherah-table__product-desc">{formatCurrency(product.total_price)}</p>
              </div>
            </td>
          </tr>
        ))}
                          ...
                          <div className="col-lg-6 col-md-6 col-12 mg-top-30">
                            <div className="sherah-table--v1">
                              <table
                                ...
                                className="sherah-table__main sherah-table__main--orderv1 sherah-border"
                              >
                                <thead className="sherah-table__head">
                                  <tr>
                                ...
                                <tbody className="sherah-table__body">
                                  ...
                                  <tr>
                                    ...
                                    <td className="sherah-table__column-2 sherah-table__data-2">
                                      <div className="sherah-table__product-content">
                                        <p className="sherah-table__product-desc sherah-color2">
                                          $-2,133.00
                                        </p>
                                      </div>
                                    </td>
                                ...
                                <ul className="sherah-vcard__contact">
                                  ...
                                  <li>
                                    <a href="#">
                                      ...
                                      3556 Hartford Way Vlg, Mount Pleasant,
                                      SC,tralia.
                                    </a>
                                  </li>
                                </ul>
