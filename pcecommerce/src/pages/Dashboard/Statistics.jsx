                            ...
                            <div className="sherah-box__body">
                              <div className="sherah-table">
                                <table className="table">
                                  ...
                                  <tbody>
                                    {stats?.recentOrders?.map((orders) => (
                                      <tr key={orders._id}>
                                        <td>#{orders._id.slice(-6)}</td>
                                        <td>
                                          {typeof orders.user_id === 'object' 
                                            ? orders.user_id._id 
                                            : orders.user_id || "N/A"}
                                        </td>
                                        <td>{orders.fullName || "Khách lẻ"}</td>
                                        <td>
                                        ...
                                        <td>
                                          <span
                                            className={`badge ${getStatusBadgeClass(orders.order_status)}`}
                                          >
                                            {translateOrderStatus(orders.order_status)}
                                          </span>
                                        </td>
                                        <td>
                                          {new Date(
