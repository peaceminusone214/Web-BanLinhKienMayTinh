...
const Statistics = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        console.log("API URL:", `${process.env.REACT_APP_API_URL}/stats/dashboard`);
        
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/stats/dashboard`);
                    ...
                    <div className="sherah-page-inner-content">
                      ...
                      <div className="row">
                            ...
                            <div className="sherah-progress-card__content">
                              <div className="sherah-progress-card__heading">
                                ...
                                <h4 className="sherah-progress-card__title">
                                  <b className="count-animate">{stats?.totalRevenue?.toLocaleString()} VND</b>
                                </h4>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                          <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
                            <div className="sherah-progress-card__icon sherah-default-bg sherah-border sherah-color2__fill">
                              <svg xmlns="http://www.w3.org/2000/svg" width="26.672" height="30.636" viewBox="0 0 26.672 30.636">
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                          <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
                            ...
                            <div className="sherah-progress-card__content">
                              <div className="sherah-progress-card__heading">
                                <span className="sherah-pcolor">Tổng sản phẩm</span>
                                <h4 className="sherah-progress-card__title">
                                  <b className="count-animate">{stats?.totalProducts}</b>
                                </h4>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                          <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
                            ...
                            <div className="sherah-progress-card__content">
                              <div className="sherah-progress-card__heading">
                                <span className="sherah-pcolor">Tổng người dùng</span>
                                <h4 className="sherah-progress-card__title">
                                  <b className="count-animate">{stats?.totalUsers}</b>
                                </h4>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="col-12">
                          <div className="sherah-box sherah-border sherah-default-bg">
                            <div className="sherah-box__header">
                              <h5 className="sherah-box__title">Doanh thu theo tháng</h5>
                            </div>
                      ...
                      <div className="row mg-top-30">
                        <div className="col-lg-6">
                          <div className="sherah-box sherah-border sherah-default-bg">
                            <div className="sherah-box__header">
                              <h5 className="sherah-box__title">Đơn hàng theo trạng thái</h5>
                            </div>
                            <div className="sherah-box__body">
                              {orderStatusData && (
                        ...
                        <div className="col-lg-6">
                          <div className="sherah-box sherah-border sherah-default-bg">
                            <div className="sherah-box__header">
                              <h5 className="sherah-box__title">Top sản phẩm bán chạy</h5>
                            </div>
                            <div className="sherah-box__body">
                              {topProductsData && (
                                <div style={{ height: "300px" }}>
                      ...
                      <div className="row mg-top-30">
                        <div className="col-lg-6">
                          <div className="sherah-box sherah-border sherah-default-bg">
                            <div className="sherah-box__header">
                              <h5 className="sherah-box__title">Đơn hàng gần đây</h5>
                            </div>
                            <div className="sherah-box__body">
                        ...
                        <div className="col-lg-6">
                          <div className="sherah-box sherah-border sherah-default-bg">
                            <div className="sherah-box__header">
                              <h5 className="sherah-box__title">Người dùng mới</h5>
                            </div>
                            <div className="sherah-box__body">
                              <div className="sherah-table">
                                <table className="table">
