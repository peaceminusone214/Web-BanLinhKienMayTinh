                ...
                <div className="col-12">
                  <div className="sherah-body">
                    ...
                    <div className="sherah-dsinner">
                      <div className="sherah-teams mg-top-40">
                        <div className="row">
                        ...
                        <div className="row">
                          <div className="col-xxl-3 col-lg-4 col-md-6 col-12">
                            {/* Sherah Vcard */}
                            <div className="sherah-vcard sherah-default-bg sherah-border mg-top-30">
                              {/* Sherah Card Body */}
                              ...
                              {/* Sherah Card Body */}
                              <div className="sherah-vcard__meta sherah-border-top">
                                <ul className="sherah-vcard__meta--info">
                                  <li>
                                    Items <span>120</span>
                                  </li>
                                  <li>
