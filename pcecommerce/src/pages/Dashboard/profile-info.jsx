                              ...
                              <div className="sherah-ptabs__inner">
                                ...
                                >
                                  ...
                                  >
                                    <form action="#">
                                      <div className="sherah-paymentm sherah__item-group sherah-default-bg sherah-border">
                                        <ul className="sherah-paymentm__list sherah-paymentm__list--notify pt-0">
                                          <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                            <div className="sherah-paymentm__name">
                                              <div className="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--1">
                                                <svg
                                                  xmlns="http://www.w3.org/2000/svg"
                                                  width="20.004"
                                                  height="17.387"
                                                  viewBox="0 0 20.004 17.387"
                                                >
                                                  <g
                                                    id="send_1_"
                                                    data-name="send (1)"
                                                  ...
                                                  >
                                                    <path
                                                      id="Path_187"
                                                      data-name="Path 187"
                                                      d="M19.992,34.2a.586.586,0,0,0-.782-.671L.378,40.72a.586.586,0,0,0,0,1.094l5.29,2.043v6.435a.586.586,0,0,0,1.109.264l2.188-4.342,5.34,3.963a.586.586,0,0,0,.91-.3C20.2,33.532,19.983,34.243,19.992,34.2Zm-4.649,2.06L6.169,42.8,2.222,41.271Zm-8.5,7.5,8-5.695C7.954,45.322,8.313,44.94,8.283,44.98c-.045.06.078-.174-1.445,2.848Zm7.5,4.983-4.7-3.488,8.5-8.965Z"
                                              ...
                                              <div className="sherah-paymentm__content">
                                                <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">
                                                  Send Inactive for 7 days
                                                </h4>
                                            ...
                                            <div className="sherah-ptabs__notify-switch  sherah-ptabs__notify-switch--two">
                                              <label className="sherah__item-switch">
                                                <input
                                                  ...
                                                  defaultChecked=""
                                                />
                                                <span className="sherah__item-switch--slide sherah__item-switch--round" />
                                              </label>
                                            </div>
                                          </li>
                                          <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                            ...
                                            <div className="sherah-paymentm__name">
                                              <div className="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--4">
                                                <svg
                                                  ...
                                                  width="14.358"
                                                  height="21.675"
                                                  viewBox="0 0 14.358 21.675"
                                                >
                                                  <g
                                                    id="Icon"
                                                    transform="translate(0.378 1.017)"
                                                  >
                                                    <g
                                                      id="Group_53"
                                                      data-name="Group 53"
                                                    ...
                                                    >
                                                      <path
                                                        id="Path_186"
                                                        data-name="Path 186"
                                                        d="M32.632,36l-6.8,2.606L19.03,36l6.8,7.85Z"
                                                        transform="translate(-19.03 -23.956)"
                                                        fill="none"
                                                        stroke="#fff"
                                                        strokeWidth={1}
                                                      />
                                                      <path
                                                        id="Path_187"
                                                        data-name="Path 187"
                                                        d="M32.541,23.349,26.716,13.03,20.89,23.349l5.826,2.234Z"
                                                        transform="translate(-19.915 -13.03)"
                                                        fill="none"
                                                        stroke="#fff"
                                                        strokeWidth={1}
                                                      />
                                            ...
                                            <div className="sherah-paymentm__name">
                                              <div className="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--5">
                                                <svg
                                                  ...
                                                  width="20.036"
                                                  height="18.364"
                                                  viewBox="0 0 20.036 18.364"
                                                >
                                                  <g
                                                    id="Icon"
                                                    transform="translate(1.214 -0.038)"
                                                  >
                                                    <path
                                                      id="Path_33"
                                                      data-name="Path 33"
                                                      d="M18.4,18.623a5.527,5.527,0,0,0-8.024,0l-.354.369-.354-.369a5.532,5.532,0,0,0-7.743-.281q-.147.135-.284.281a6,6,0,0,0,0,8.241L9.5,35.04a.723.723,0,0,0,1.012.027l.027-.027L18.4,26.863A6,6,0,0,0,18.4,18.623ZM17.362,25.89h0L10.02,33.527,2.678,25.89a4.585,4.585,0,0,1,0-6.3A4.087,4.087,0,0,1,8.4,19.367q.12.109.23.227L9.5,20.5a.745.745,0,0,0,1.04,0l.873-.908a4.087,4.087,0,0,1,5.719-.227q.12.109.23.227A4.543,4.543,0,0,1,17.362,25.89Z"
                                                      transform="translate(-1.214 -16.859)"
                                                      fill="#fff"
                                                    />
                                                  </g>
                                                </svg>
                                            ...
                                            <div className="sherah-paymentm__name">
                                              <div className="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--5">
                                                <svg
                                                  ...
                                                  width="18.956"
                                                  height="18.925"
                                                  viewBox="0 0 18.956 18.925"
                                                >
                                                  <path
                                                    id="star_1_"
                                                    data-name="star (1)"
                                                    d="M16.971,6.241l-5.36-.819L9.21.305a.567.567,0,0,0-.986,0l-2.4,5.117-5.36.819a.545.545,0,0,0-.307.919l3.894,3.991-.92,5.642a.545.545,0,0,0,.8.564l4.787-2.646L13.5,17.358a.545.545,0,0,0,.8-.564l-.92-5.642L17.279,7.16a.545.545,0,0,0-.307-.92Z"
                                                    transform="translate(0.761 0.732)"
                                                    fill="none"
                                                    stroke="#fff"
                                                    strokeWidth="1.5"
                                                  />
