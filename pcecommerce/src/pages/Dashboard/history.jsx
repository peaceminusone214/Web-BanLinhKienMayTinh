                ...
                <div className="col-12 sherah-main__column">
                  <div className="sherah-body">
                    ...
                    <div className="sherah-dsinner">
                      <div className="sherah-page-inner sherah-default-bg mg-top-30">
                        <div className="row">
                          <div className="col-12">
                            {/* Charts Three */}
                            <div className="charts-main sherah-offset-bg">
                              <div className="sherah-chart__dropdown--revenue mg-btm-30">
                                {/* Top Heading */}
                        ...
                        <div className="row sherah-gap-30">
                          <div className="col-lg-6 col-12">
                            {/* Charts Two */}
                            <div className="charts-main sherah-offset-bg mg-top-30">
                              ...
                              <div className="tab-content" id="nav-tabContent">
                                ...
                                >
                                  <div className="sherah-chart__inside sherah-chart__daily-vistior-v2">
                                    <canvas id="myChart_Total_Daily_visitor" />
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="col-lg-6 col-12">
                            {/* Charts One */}
                            <div className="charts-main sherah-offset-bg  mg-top-30">
                              <div className="row sherah-flex-between">
                                <div className="col-lg-6 col-12">
                                  {/* Top Heading */}
                                  ...
                                  <div className="sherah-flex-between mg-top-30 mg-btm-30">
                                    <div className="charts-main__middle m-0">
                                      <ul className="sherah-progress-list sherah-progress-list__bg ">
                                        <li>
                                ...
                                <div className="col-lg-6 col-12">
                                  <div className="sherah-grap-chart">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      xmlnsXlink="http://www.w3.org/1999/xlink"
                                      width="244.049"
                                      height="207.741"
                                      viewBox="0 0 244.049 207.741"
                                    >
                                      <defs>
                                        <linearGradient
                                          id="linear-gradient"
                                      ...
                                      <g
                                        id="Grap"
                                        transform="translate(-713.891 -350.213)"
                                      >
                                        <path
                                          id="Path_178"
                                          data-name="Path 178"
                                        ...
                                        <path
                                          ...
                                          transform="translate(41.974 39.683)"
                                          fill="none"
                                          stroke="#fff"
                                          strokeMiterlimit={10}
                                          strokeWidth="0.25"
