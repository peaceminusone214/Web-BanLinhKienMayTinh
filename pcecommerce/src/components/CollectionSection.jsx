        ...
        return [
            {
                ...
                products: products.filter(p =>
                    ["67d0ea7ce8b0d2e73733324c", "67d0ef95e8b0d2e73733330e", "67d0ed29e8b0d2e7373332e4", "67d0eb11e8b0d2e73733326c", "67d0eed1e8b0d2e7373332f6"].includes(p._id)
                ),
            },
            {
                id: 2,
                ...
                products: products.filter(p =>
                    ["67d0eed2e8b0d2e7373332fe", "67d0ef95e8b0d2e73733330e", "67d0f278e8b0d2e73733337e", "67d0ef95e8b0d2e73733330a", "67d0eb12e8b0d2e73733326e"].includes(p._id)
                ),
            },
            {
                id: 3,
            ...
            <div className="box-header">
                ...
                <ul className="list-style-none d-flex align-items-center justify-content-between">
                    {tabs.map((tab) => (
                        <li
                            key={tab.id}
                            className={`js-collection-button ${selectedTab.id === tab.id ? "cat-active" : ""}`}
