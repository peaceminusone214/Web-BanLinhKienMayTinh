            ...
            <div className="admin-menu__one sherah-sidebar-padding">
              ...
              <div className="menu-bar">
                ...
                >
                  ...
                  <li>
                    <a
                      className={`collapsed ${isVendorsOpen ? "show" : ""}`}
                      ...
                      <span className="menu-bar__text">
                        <span className="sherah-menu-icon sherah-toggleMenu-icon__v1">
                          ...
                          >
                            <g
                              id="Icon"
                              transform="translate(-325.516 -274.72)"
                            >
                              <path
                                id="Path_221"
                                data-name="Path 221"
                  ...
                  <li>
                    ...
                    >
                      <span className="menu-bar__text">
                        ...
                        <span className="menu-bar__name">Sản phẩm</span>
                      </span>
                      <span className="sherah__toggle" />
                    </a>
                    <div
                  ...
                  <li>
                    <Link to="/admin/discount" className="collapsed">
                      <span className="menu-bar__text">
                        ...
                        <span className="menu-bar__name">Mã giảm giá</span>
                      </span>
                    </Link>
                  </li>
                  {/* Orders menu item */}
                  <li>
                    <a
                      className={`collapsed ${isOrdersOpen ? "show" : ""}`}
                      onClick={toggleOrdersDropdown} // Attach toggle function
                    >
                      <span className="menu-bar__text">
                        <span className="sherah-menu-icon sherah-svg-icon__v1">
                          <svg
                          ...
                          >
                            <g
                              id="Icon"
                              transform="translate(-409.241 -375.497)"
                            >
                              <path
                                id="Path_219"
                                data-name="Path 219"
                        ...
                        <span className="menu-bar__name">Đơn hàng</span>
                      </span>
                      <span className="sherah__toggle" />
                    </a>
                    <div
                  ...
                  <li>
                    <Link to="/admin/invoiceprint" className="collapsed">
                      <span className="menu-bar__text">
                        ...
                        <span className="menu-bar__name">X-Invoice</span>
                      </span>
                    </Link>
                  </li>
                  {/* History menu item */}
                  <li>
                    <Link to="/admin/history" className="collapsed">
                      <span className="menu-bar__text">
                        <span className="sherah-menu-icon sherah-svg-icon__v1">
                          <svg
                            className="sherah-svg-icon"
                      ...
                      <span className="menu-bar__text">
                        <span className="sherah-menu-icon sherah-svg-icon__v1">
                          ...
                          >
                            <g
                              id="Icon"
                              transform="translate(-336.061 -361.698)"
                            >
                              <path
                                id="Path_230"
                                data-name="Path 230"
                  ...
                  <li>
                    <a
                      className={`collapsed ${isPagesOpen ? "show" : ""}`}
                      onClick={togglePagesDropdown} // Attach toggle function
                    >
                      <span className="menu-bar__text">
                        <span className="sherah-menu-icon sherah-svg-icon__v1">
                          <svg
                          ...
                          >
                            <g
                              id="Icon"
                              transform="translate(-451.809 -436.251)"
                            >
                              <path
                                id="Path_234"
                                data-name="Path 234"
                        ...
                        <span className="menu-bar__name">X-Page</span>
                      </span>
                      <span className="sherah__toggle" />
                    </a>
                    <div
                    ...
                    >
                      <ul className="menu-bar__one-dropdown">
                        ...
                        <li>
                          <Link to="/admin/faq">
                            <span className="menu-bar__text">
                              <span className="menu-bar__name">Faqs</span>
                            </span>
                          </Link>
                        </li>
                      </ul>
                  ...
                  {/* Languages menu item */}
                  <li>
                    <Link to="/admin/languages" className="collapsed">
                      <span className="menu-bar__text">
                        <span className="sherah-menu-icon sherah-svg-icon__v1">
                          <svg
                            className="sherah-svg-icon"
                            ...
                            width="20.929"
                            height="20.929"
                            viewBox="0 0 20.929 20.929"
                          >
                            <g
                              id="Icon"
                              transform="translate(-466.296 -331.887)"
                            >
                              <path
                                id="Path_237"
                                data-name="Path 237"
                  ...
                  {/* Login menu item */}
                  <li>
                    <Link to="/admin/login" className="collapsed">
                      <span className="menu-bar__text">
                        <span className="sherah-menu-icon sherah-svg-icon__v1">
                          <svg
                            className="sherah-svg-icon"
                          ...
                          >
                            <g
                              id="Icon"
                              transform="translate(-209.904 -251.466)"
                            >
                              <path
                                id="Path_240"
                                data-name="Path 240"
                        ...
                        <span className="menu-bar__name">X-Login</span>
                      </span>
                    </Link>
                  </li>
                </ul>
