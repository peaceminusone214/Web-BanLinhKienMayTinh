    ...
    <section className="section-news" id="js-article-2-container">
      <div className="container news box-article-footer">
        <div className="box-header-news d-flex align-items-center justify-content-between">
          ...
          <a href="/tin-tuc" className="color-secondary box-sub-heading btn-view-more font-weight-500 text-16 hover-primary">XEM TẤT CẢ +</a>
        </div>
        
        <div className="box-content article-content">
          <ul className="grid grid--4-cols list-style-none" id="js-article-holder">
            {articles.map(article => (
              <li key={article.id} className="article-item">
                ...
                <div className="article-content">
                  <a href={article.link} className="article-name line-clamp-2 font-weight-600">
