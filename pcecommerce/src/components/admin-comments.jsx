                  ...
                  <div className="col-12">
                    <div className="mg-top-30">
                        ...
                        >
                          <thead className="sherah-table__head">
                            <tr>
                              ...
                              <th className="sherah-table__column-1 sherah-table__h1">ID</th>
                              ...
                              <th className="sherah-table__column-7 sherah-table__h7">Hành động</th>
                            </tr>
                          </thead>
                          <tbody className="sherah-table__body">
                            {comments.length > 0 ? (
                                  ...
                                  <td className="sherah-table__column-1 sherah-table__data-1">
                                    <div className="sherah-table__product--id">
                                      <p
                                        ...
                                        onClick={() => toggleIdDisplay(comment._id)}
                                      >
                              ...
                              <tr>
                                <td colSpan="8" className="sherah-table__product-desc">
                                  No comments found.
                                </td>
                              </tr>
                            )}
                      ...
                      <div className="admin-replies-filter__container">
                        <h4 className="admin-replies-heading">Quản lý Phản Hồi Bình Luận</h4>
                            ...
                            {replies.length > 0 ? (
                              replies.map((reply) => (
                                <tr key={reply._id}>
                                  ...
                                  <td>{reply.content}</td>
                                  <td>{reply.reports && reply.reports.length > 0 ? "Bị báo cáo" : "Không"}</td>
                                  <td>
                                    <button
