                      ...
                      <div className="col-lg-6 col-12">
                        ...
                        <div className="charts-main sherah-default-bg charts-home-two sherah-border mg-top-30">
                          <div className="charts-main__heading  mg-btm-20 charts-main__heading--v2">
                            <h3 className="sherah-heading__title">
                              Total sales
                            </h3>
                            ...
                            <div className="sherah-order-card sherah-default-bg sherah-border sherah-flex-between mg-top-30">
                              <div className="sherah-order-card__first">
                                <p className="sherah-order-card__text mg-btm-10">
                                  Active Creator{" "}
                                  <span className="sherah-bcolor">86,346</span>
                                </p>
                                <div className="sherah-chart__inside sherah-chart__inside--aorder">
                                  <canvas id="myChart_active_creators" />
                                </div>
                              </div>
                              <div
                          ...
                          <div className="sherah-flex-between mg-btm-30">
                            <div className="charts-main__middle m-0">
                              <ul className="sherah-progress-list sherah-progress-list__bg sherah-progress-list__inline sherah-gap-50">
                                <li>
                                  <span className="sherah-progress-list__color sherah-color4__bg" />
                                  <p>
                                    Profit <span>13,570</span>
                                  </p>
                                </li>
                                <li>
                                  <span className="sherah-progress-list__color sherah-color1__bg" />
                                  <p>
                                    Refunds<span>455,877</span>
                                  </p>
                                </li>
                                <li>
                                  <span className="sherah-progress-list__color sherah-color3__bg" />
                                  <p>
                                ...
                                <li className="nav-item dropdown">
                                  ...
                                  <ul className="dropdown-menu sherah-sidebar_dropdown">
                                    <a
                                      className="list-group-item"
                                      data-bs-toggle="list"
                                      data-bs-target="#sherah-chart__t1"
                                      role="tab"
                                    >
                                      Last 15 Days
                                    </a>
                              ...
                              <tr>
                                ...
                                <td className="sherah-table__column-2 sherah-table__data-2">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/customer-1.png"
                                        alt="#"
                                      />
                                    </div>
                                ...
                                <td className="sherah-table__column-3 sherah-table__data-3">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/product-1.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                              ...
                              <tr>
                                ...
                                <td className="sherah-table__column-2 sherah-table__data-2">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/customer-2.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                              ...
                              <tr>
                                ...
                                <td className="sherah-table__column-2 sherah-table__data-2">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/customer-3.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                                ...
                                <td className="sherah-table__column-3 sherah-table__data-3">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/product-3.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                              ...
                              <tr>
                                ...
                                <td className="sherah-table__column-2 sherah-table__data-2">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/customer-4.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                                ...
                                <td className="sherah-table__column-3 sherah-table__data-3">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/product-4.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                              ...
                              <tr>
                                ...
                                <td className="sherah-table__column-2 sherah-table__data-2">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/customer-5.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                                ...
                                <td className="sherah-table__column-3 sherah-table__data-3">
                                  <div className="sherah-table__product">
                                    <div className="sherah-table__product-img">
                                      <img
                                        src="/assets/interface-dashboard/img/product-5.png"
                                        alt="#"
                                      />
                                    </div>
                                    <div className="sherah-table__product-content">
                          ...
                          <div className="sherah-product-slider">
                            ...
                            <div className="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                              ...
                              <div className="sherah-product-card__img">
                                <img src="/assets/interface-dashboard/img/product-slider-1.png" />
                              </div>
                              {/* Card Content */}
                            ...
                            <div className="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                              {/* Card Image */}
                              <div className="sherah-product-card__img">
                                <img src="/assets/interface-dashboard/img/product-slider-2.png" />
                              </div>
                              {/* Card Content */}
                              <div className="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                <h4 className="sherah-product-card__title">
                            ...
                            <div className="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                              {/* Card Image */}
                              <div className="sherah-product-card__img">
                                <img src="/assets/interface-dashboard/img/product-slider-3.png" />
                              </div>
                              {/* Card Content */}
                              <div className="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                <h4 className="sherah-product-card__title">
                            ...
                            <div className="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                              {/* Card Image */}
                              <div className="sherah-product-card__img">
                                <img src="/assets/interface-dashboard/img/product-slider-4.png" />
                              </div>
                              {/* Card Content */}
                              <div className="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                <h4 className="sherah-product-card__title">
                            ...
                            <div className="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                              {/* Card Image */}
                              <div className="sherah-product-card__img">
                                <img src="/assets/interface-dashboard/img/product-slider-5.png" />
                              </div>
                              {/* Card Content */}
                              <div className="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                <h4 className="sherah-product-card__title">
                            ...
                            <div className="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                              {/* Card Image */}
                              <div className="sherah-product-card__img">
                                <img src="/assets/interface-dashboard/img/product-slider-6.png" />
                              </div>
                              {/* Card Content */}
                              <div className="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                <h4 className="sherah-product-card__title">
